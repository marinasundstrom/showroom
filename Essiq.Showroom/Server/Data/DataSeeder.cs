...
namespace Essiq.Showroom.Server.Data
{
    public static class DataSeeder
    {
        ...
        public static async Task SeedDevData(IServiceProvider sp, ApplicationDbContext context)
        {
            ...
            if (await userManager.FindByNameAsync("daniel.aberg@essiq.se") == null)
            {
            ...
            if (await userManager.FindByNameAsync("jorgen.nilsson@essiq.se") == null)
            {
                var managerProfile = new ManagerProfile()
                {
                    FirstName = "Jörgen",
                    LastName = "Nilsson",
                    Email = "jorgen.nilsson@essiq.se",
            ...
            if (await userManager.FindByNameAsync("mikael.hall@essiq.se") == null)
            {
                var managerProfile = new ManagerProfile()
                {
                    FirstName = "Mikael",
                    LastName = "Häll",
                    Email = "mikael.hall@essiq.se",
            ...
            if (await userManager.FindByNameAsync("marcus.ekerhult@essiq.se") == null)
            {
                var managerProfile = new ManagerProfile()
                {
                    FirstName = "Marcus",
                    ...
                    Email = "marcus.ekerhult@essiq.se",
            ...
            if (await userManager.FindByNameAsync("sofie.bondeson") == null)
            {
                var consultantProfile = new ConsultantProfile()
                {
                    FirstName = "Sofie",
                    LastName = "Bondeson",
                    Email = "sofie.bondeson@essiq.se",
                    PhoneNumber = "",
                    OrganizationId = (await context.Organizations.FindAsync("syd")).Id,
                    ManagerId = (await context.UserProfiles.FirstAsync(x => x.Email == "daniel.aberg@essiq.se")).Id,
            ...
            if (await userManager.FindByNameAsync("nermin.paratusic") == null)
            {
                var consultantProfile = new ConsultantProfile()
                {
                    FirstName = "Nermin",
                    LastName = "Paratusic",
                    Email = "nermin.paratusic@essiq.se",
            ...
            if (await userManager.FindByNameAsync("christian.nilsson") == null)
            {
                var consultantProfile = new ConsultantProfile()
                {
                    FirstName = "Christian",
                    LastName = "Nilsson",
                    Email = "christian.nilsson@essiq.se",
                    PhoneNumber = "",
                    OrganizationId = (await context.Organizations.FindAsync("syd")).Id,
                    ManagerId = (await context.UserProfiles.FirstAsync(x => x.Email == "daniel.aberg@essiq.se")).Id,
                    CompetenceAreaId = (await context.CompetenceAreas.FindAsync("software")).Id,
            ...
            if (await userManager.FindByNameAsync("niklas.martensson") == null)
            {
                var consultantProfile = new ConsultantProfile()
                {
                    FirstName = "Niklas",
                    LastName = "Mårtensson",
                    Email = "niklas.martensson@essiq.se",
                    PhoneNumber = "",
                    OrganizationId = (await context.Organizations.FindAsync("syd")).Id,
                    ManagerId = (await context.UserProfiles.FirstAsync(x => x.Email == "mikael.hall@essiq.se")).Id,
            ...
            if (await userManager.FindByNameAsync("johanna.sjoberg") == null)
            {
                var consultantProfile = new ConsultantProfile()
                {
                    FirstName = "Johanna",
                    LastName = "Sjöberg",
                    Email = "johanna.sjoberg@essiq.se",
                    PhoneNumber = "",
                    OrganizationId = (await context.Organizations.FindAsync("syd")).Id,
                    ManagerId = (await context.UserProfiles.FirstAsync(x => x.Email == "mikael.hall@essiq.se")).Id,
            ...
            if (await userManager.FindByNameAsync("per.nilsson@borgwarner.com") == null)
            {
                var consultantProfile = new ClientProfile()
                {
                    ...
                    OrganizationId = (await context.Organizations.FindAsync("syd")).Id,
                    ReferenceId = (await context.UserProfiles.FirstAsync(x => x.Email == "mikael.hall@essiq.se")).Id,
                };
            ...
            if (await userManager.FindByNameAsync("maria.sjolund@axis.com") == null)
            {
                var consultantProfile = new ClientProfile()
                {
                    ...
                    OrganizationId = (await context.Organizations.FindAsync("syd")).Id,
                    ReferenceId = (await context.UserProfiles.FirstAsync(x => x.Email == "daniel.aberg@essiq.se")).Id,
                };
            ...
            if (await userManager.FindByNameAsync("anders.bengtsson@volvocars.com") == null)
            {
                var consultantProfile = new ClientProfile()
                {
                    ...
                    OrganizationId = (await context.Organizations.FindAsync("vast")).Id,
                    ReferenceId = (await context.UserProfiles.FirstAsync(x => x.Email == "marcus.ekerhult@essiq.se")).Id,
                };
